...
public class UpdateCategoryTest
{
    ...
    public async Task UpdateCategory(Entity.Category exampleCategory, UpdateCategoryInput updateCategoryInput)
    {
    ...
    public void ThrowWhenCantUpdateCategory(UpdateCategoryInput input, string expectedExceptionMessage)
    {
        ...
        task.Should().ThrowAsync<EntityValidationException>().WithMessage(expectedExceptionMessage);
        repositoryMock.Verify(x => x.Get(exampleCategory.Id, It.IsAny<CancellationToken>()), Times.Once);
    }
}
